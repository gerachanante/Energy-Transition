...
data = pd.read_excel('d.ETCleanDummyLI.xlsx')
...
imp.to_excel(r'D:\OneDrive - International Renewable Energy Agency - IRENA\05.Master Thesis\05.Analysis\02.RF Feature Impotances\d.ET.RF ResultsLow Income.xlsx', 
