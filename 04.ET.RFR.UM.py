...
data = pd.read_excel('d.ETCleanDummyUM.xlsx')
...
imp.to_excel(r'D:\OneDrive - International Renewable Energy Agency - IRENA\05.Master Thesis\05.Analysis\02.RF Feature Impotances\d.ET.RF ResultsUpper Middle Income.xlsx', 
